...
public class NbuRate {
    ...
    public static NbuRate fromJsonObject(JSONObject jsonObject) throws JSONException {
        ...
        try { nbuRate.setExchangeDate(dateFormat.parse(jsonObject.getString("exchangedate"))); }
        catch(ParseException ex) { throw new JSONException(ex.getMessage()); }
        return nbuRate;
    }
